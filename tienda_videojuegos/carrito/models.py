...
class Carrito(models.Model):
    ...
    def total_precio(self):
        # Retorna el precio total de los items en el carrito
        return sum(item.subtotal() for item in self.items.all())
    
class ItemCarrito(models.Model):
    #Elemento individual en el carrito (un juego y su cantidad)
    ...
    def subtotal(self):
        # Retorna el subtotal para este item (precio del juego * cantidad)
